...
const roles = [
  {
    ...
    type: "Full-Time",
    desc: "Build autonomous multi-agent systems, prompt pipeline orchestration frameworks, and real-time MCP servers for EMR interaction.",
    icon: Brain,
  ...
  },
  {
    ...
    location: "San Francisco, CA / Remote",
    type: "Full-Time",
    desc: "Architect scalable FHIR R4/R5 database stores, sub-10ms edge APIs, and zero-knowledge HIPAA VPC data pipelines.",
    icon: Code,
    color: "text-blue-500",
  ...
  },
  {
    ...
    location: "San Francisco, CA / Remote",
    type: "Full-Time",
    desc: "Craft high-aesthetic React 19 / Next.js enterprise consoles, glassmorphic interfaces, and fluid Framer Motion animations.",
    icon: Layout,
  ...
  },
  {
    ...
    type: "Full-Time",
    desc: "Fine-tune 100B+ parameter bio-foundation models on PubMed, 3D molecular protein docking datasets, and ADMET profiles.",
    icon: Cpu,
  ...
  },
  {
    ...
    location: "San Francisco, CA / Remote",
    type: "Full-Time",
    desc: "Board-certified physician or clinical informatics expert evaluating triage accuracy, safety rules, and ICD-10 decision trees.",
    icon: Stethoscope,
    color: "text-rose-500",
  ...
  },
  {
    ...
    location: "San Francisco, CA",
    type: "Full-Time",
    desc: "Pioneer new generative biochemistry architectures, graph neural network algorithms, and zero-hallucination RAG frameworks.",
    icon: FlaskConical,
  ...
  {
    id: "internships",
    title: "AI Research & Engineering Internships",
    department: "University Programs",
    location: "San Francisco, CA / Hybrid",
    type: "Internship (Summer / Fall 2026)",
    desc: "Paid 12-week fellowship for BS, MS, and PhD students conducting hands-on research alongside senior AI engineers.",
    icon: GraduationCap,
    color: "text-teal-500",
